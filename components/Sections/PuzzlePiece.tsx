...
function PuzzlePiece() {
  return (
    <div className="w-full flex items-center bg-puzzlebg border border-black-10 rounded-md px-2 py-4 mb-4">
      ...
      <div className="w-3/12 grid grid-cols-5 gap-2 pr-4 pl-2 font-normal text-xs">
        <div className=" w-full items-center border-[0.5px] border-black-50 px-1 rounded-lg">
          <Image src="/pdf.svg" width={13} height={16} alt="icon" /> 10
        </div>
        <div className="flex w-full items-center border-[0.5px] border-black-50 px-1 rounded-lg">
        ...
        <div className="flex w-ful items-center border-[0.5px] border-black-50 px-1 rounded-lg">
          <Image src="/media.svg" width={17.5} height={14} alt="icon" /> 10
        </div>
      </div>
      <span className="w-2/12 pr-4 pl-2">$45</span>
